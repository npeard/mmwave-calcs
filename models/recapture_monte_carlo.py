...
def newton_3d(f, t, omega_H, omega_L):
    ...
    f : list
        ...
        [x, vx, y, vy, z, vz]
    t : float
        Time at which to calculate the next position and velocity.
    omega_H : float
        Radial trap angular frequency
    omega_L : float
        Longitudinal trap angular frequency
...
def monte_carlo_3d(t, omega_H, omega_L, T_ensemble, N_ensemble=50, trapping_laser=1070e-9, D2_line=852e-9, mass=Caesium().mass, do_iHO=False):
    """
    ...
    trapping_laser : float, optional
        Wavelength of the trapping laser in nm. Default is 1070 nm.
    D2_line : float, optional
        Wavelength of the D2 line in nm. Default is 852 nm.
    mass : float, optional
        Mass of the trap particles in kg. Default is the mass of caesium.
...
def recapture_rate_3d(t, omega_H, omega_L, trap_temp, T_ensemble, mass=Caesium().mass, do_iHO=False):
    """
...
def tweezer_temperature_regress(recapture_time, recapture_rate,
    ...
    omega_H, omega_L, trap_temp = get_trap_freqs(tweezer_power, tweezer_waist)
...
def run_model(recapture_time, recapture_rate, tweezer_power, quantify_error=False, true_T_ensemble=None):
    """
